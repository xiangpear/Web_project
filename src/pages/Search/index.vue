            ...
            <div class="navbar-inner filter">
              ...
              <ul class="sui-nav">
                <li :class="{active: isOne}" @click="changeOrder('1')">
                  <a>综合<span v-show="isOne" class="iconfont" :class="{'icon-up': isAsc, 'icon-down1': isDesc}" style="font-size: 20px;"></span></a>
                </li>
                <li :class="{active: isTwo}" @click="changeOrder('2')">
                  <a>价格<span v-show="isTwo" class="iconfont" :class="{'icon-up': isAsc, 'icon-down1': isDesc}" style="font-size: 20px;"></span></a>
                </li>
              </ul>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    // 排序的操作
    changeOrder(flag) {
      // flag形参：是一个标记，代表用户点击的是综合（1）还是 价格（2）
